        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div>
            ...
            <input
              ...
              disabled={loading}
              autoFocus
              className="mt-1.5 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-800 focus:border-indigo-300 focus:outline-none disabled:opacity-60"
            />
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 rounded-full bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 disabled:opacity-50"
            >
