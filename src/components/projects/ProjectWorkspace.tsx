            ...
            <div className="grid gap-4 lg:grid-cols-[1fr_1.2fr]">
              <label className="block text-sm font-medium text-slate-700">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none focus:border-indigo-300"
            ...
            <form onSubmit={handleAddMember} className="mt-6 space-y-3">
              <div className="grid gap-3 md:grid-cols-[1fr_140px]">
                <input
                  ...
                  className="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none focus:border-indigo-300"
            ...
            <>
              ...
              <form onSubmit={handleCreateTask} className="mt-6 space-y-3">
                ...
                <button
                  type="submit"
                  disabled={taskLoading}
                  className="rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 px-5 py-2 text-sm font-semibold text-white disabled:opacity-60"
                >
